...
namespace ErenshorPartyTools
{
    ...
    internal static class SuiteUiPolicy
    {
        ...
        internal static bool ShouldShowStandaloneLauncher(bool bridgeRegistered, bool preference)
        {
            return SuiteLauncherPolicy.ShouldShow(IsGameplayReady(), IsHubAvailable(), bridgeRegistered, preference);
        }
